...
def _register_default_factories(registry: ModuleRegistry, vram: "VRAMConfig | None" = None) -> None:
    ...
    registry.register(
        ...
        lambda cfg: ScreenCapture(
            ...
            preview_resize_width=cfg.preview_resize_width,
            preview_jpeg_quality=cfg.preview_jpeg_quality,
            inference_resize_width=cfg.inference_resize_width,
            inference_jpeg_quality=cfg.inference_jpeg_quality,
        ),
        requires_gpu=False,
